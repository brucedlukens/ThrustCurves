...
| GM 2500/3500HD 2027 addition | 8.3L Duramax (L6P, "Megamax") 555 hp / 1,230 lb-ft (GM announcement, 2026-09; GM Authority "8.3L V8 Duramax Diesel Output Revealed"); Allison 10-speed per the 2027 order guide | Peak rpm (GM withheld; torque plateau 1,600–1,800 and power peak 2,800 assumed), 10L1000 ratios / 3.42 axle / governor / tires carried from the L5P, curb weight (L5P + 70 kg estimate), curve shape |
...
- **GM HD**: L8T gas ran the 6L90 6-speed 2020–2023, Allison-branded 10L1000
  ...
  For 2027 the 8.3L L6P (555 hp / 1,230 lb-ft) is added to the 2020+ HD
  entries with `yearStart: 2027`. GM hasn't said whether the L5P carries on
  alongside it, so the L5P stays open-ended until that's confirmed.
